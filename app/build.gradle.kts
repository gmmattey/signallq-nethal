...
dependencies {
    ...
    implementation(project(":feature:wifi-network"))
    implementation(project(":feature:devices"))
    implementation(project(":feature:tools-ping"))
    implementation(project(":feature:tools-speedtest"))
    implementation(project(":feature:tools-dns"))
    implementation(project(":feature:tools-traceroute"))
    implementation(project(":feature:tools-reboot-wan"))
